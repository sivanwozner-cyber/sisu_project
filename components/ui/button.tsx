  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        neon: "bg-gradient-neon text-primary-foreground shadow-glow hover:shadow-glow-lg",
        outline:
          "border border-primary/40 bg-transparent text-foreground hover:border-primary hover:shadow-glow-sm hover:text-primary",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:shadow-glow-violet",
